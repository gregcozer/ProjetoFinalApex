...
namespace Tests.Services
{
    public class UserServiceTests
    {
        ...
        public async Task MetodoCreateAsync_Chama_UserRepository_Delete_E_SaveChangesAsync_E_Retornatrue()
        {
            //Preparação (Arrange)
            var userId = 1;
        ...
        public async Task Delete_QuandoNaoExisteUsuario_ReturnaFalse()
        {
            //Preparação (Arrange)
            var userId = 1;
        ...
        public async Task UpdateAsync_QuandoExisteUsuario_Chama_UserRepository_Update_E_SaveChanges_E_RetornaTrue()
        {
            //Preparação (Arrange)
        ...
        public async Task UpdateToAdmin_QuandoNaoExisteUsuario_NaoChama_UserRepository_Update_E_SaveChanges()
        {
            //Preparação (Arrange)
            var userId = 1;
